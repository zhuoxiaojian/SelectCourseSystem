...
document.write('<td align="center" id="tdTiannetDay36" onClick="tiannetDay=this.innerText;tiannetSetValue(true);" ' 
    +' style="' + s_tiannet_day + '">&nbsp;</td>');
document.write('<td align="right" colspan="5"><a href="javascript:tiannetClear();" style="' + s_tiannet_link + '"><input type="button" value="清空"/></a>'+
    '<a href="javascript:tiannetHideControl();" style="' + s_tiannet_link + '"><input type="button" value="关闭"/></a>' +
    '<a href="javascript:tiannetSetValue(true);" style="' + s_tiannet_link + '"><input type="button" value="确定"/></a>&nbsp;' +
    '</td>');
document.write (' </tr>');
document.write('</table>');
document.write('</div>');
